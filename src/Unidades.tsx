...
function Unidades({ onVolver }: Props) {
  ...
  // --- Agregación por Unidad (id_vehiculo) ---
  const resumenPorUnidad: FilaUnidad[] = (() => {
    ...
    for (const row of datos) {
      ...
      if (row.fecha && row.fecha >= fila.fechaMasReciente) {
        ...
        fila.rendEstandarMasReciente = estandar;
      }
    ...
    if (busquedaUnidad.trim()) {
      const termino = busquedaUnidad.toLowerCase();
      filas = filas.filter(f => f.idVehiculo.toLowerCase().includes(termino));
    }
  ...
  return (
    <div style={{ backgroundColor: "#0f172a", minHeight: "100vh", color: "white", fontFamily: "Arial, sans-serif" }}>
      <div style={{ backgroundColor: "#1e293b", padding: "16px 32px", display: "flex", alignItems: "center", gap: "12px", borderBottom: "2px solid #c0392b" }}>
        ...
        <h1 style={{ margin: 0, fontSize: "20px", color: "#f1f5f9" }}>Unidades</h1>
      </div>
      ...
      <div style={{ padding: "24px 32px", backgroundColor: "#1e293b", borderBottom: "1px solid #334155" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "12px", alignItems: "end" }}>
          ...
          <div>
            <p style={{ color: "#94a3b8", fontSize: "12px", margin: "0 0 4px" }}>Buscar Unidad</p>
            <input type="text" placeholder="Ej. T17401..." value={busquedaUnidad} onChange={e => setBusquedaUnidad(e.target.value)} style={inputStyle} />
          </div>
          <div>
      ...
      <div style={{ padding: "24px 32px", display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: "16px" }}>
        ...
        <div style={{ backgroundColor: "#1e293b", borderRadius: "12px", padding: "20px", borderTop: "4px solid #94a3b8" }}>
          ...
          <h2 style={{ color: "#f1f5f9", margin: "8px 0 0", fontSize: "26px" }}>{rendEstandarGlobal.toFixed(2)} <span style={{ fontSize: "13px" }}>km/L</span></h2>
        </div>
        <div style={{ backgroundColor: "#1e293b", borderRadius: "12px", padding: "20px", borderTop: "4px solid #3b82f6" }}>
          ...
          <h2 style={{ color: "#3b82f6", margin: "8px 0 0", fontSize: "26px" }}>{rendPromedioGlobal.toFixed(2)} <span style={{ fontSize: "13px" }}>km/L</span></h2>
        </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", minWidth: "1100px" }}>
                <thead>
                  <tr style={{ borderBottom: "1px solid #334155" }}>
                    <th style={{ color: "#94a3b8", textAlign: "left", padding: "12px", fontWeight: "normal" }}>Unidad</th>
                    <th style={{ color: "#94a3b8", textAlign: "right", padding: "12px", fontWeight: "normal" }}>Rend. Estándar</th>
                    ...
                    <th style={{ color: "#94a3b8", textAlign: "center", padding: "12px", fontWeight: "normal" }}># Choferes</th>
                  </tr>
                </thead>
                <tbody>
                  {resumenPorUnidad.map((fila, i) => {
                    ...
                    return (
                      <>
                        <tr
                          key={i}
                          onClick={() => setUnidadExpandida(expandida ? null : fila.idVehiculo)}
                        ...
                        >
                          ...
                          <td style={{ padding: "12px", color: "#8b5cf6", textAlign: "center" }}>{fila.conductores.size}</td>
                        </tr>
                        {expandida && (
